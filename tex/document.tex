\documentclass[a4paper,pagesize=pdftex,11pt]{article}
...
\begin{center}
  ...
  {\small \url{https://github.com/adericbourg/thecore-fr}}
\end{center}
...
\section{Protocoles Fondamentaux}
...
\begin{enumerate}
	\item Celui qui a la parole annonce son état émotionnel. Cela peut être :
	      ...
	      \begin{itemize}
	      	...
	      	\item Ou, si d'autres se sont déjà exprimé lors de l'entrée, il peut dire \og{}je passe\fg{}.
	      \end{itemize}
...
\subsection{Contrôle de protocole}
...
\subsection{Contrôle d'intention}
...
\begin{itemize}
	...
	\item Assurez-vous de vouloir résoudre paisiblement tout conflit potentiel avant de contrôler l'intention de qui que ce soit.
	      Si vous n'avez pas d'intention pacifique, sortez.
...
\subsubsection{Remarques}
\begin{itemize}
	\item Si le conflit qui émerge semble impossible à résoudre, sortez et demandez de l'aide.
\end{itemize}
...
\begin{enumerate}
	...
	\item Le proposant abandonne sa proposition si le total de \textsc{non} et de \textsc{je soutiens} est \og{}trop grand\fg{} ou s'il estime qu'il ne parviendra
	      pas à mener un protocole de \emph{Résolution} à son terme. \og{}Trop grand\fg{} suit l'heuristique suivante :
	      \begin{itemize}
...
\begin{itemize}
	...
	\item Ne passez pas durant un protocole de \emph{Décision}.
...
\begin{itemize}
	...
	\item Si vous avez un doute vis-à-vis d'une proposition, ap\-portez-lui un soutien neutre (\textsc{je soutiens}) et demandez des explications une fois que le
	      protocole est terminé. Si vous avez une proposition plus pertinente à soumettre, ayez confiance en l'équipe pour la soutenir.
...
\subsection{Jeu de la perfection}
...
\subsection{Alignement personnel}
